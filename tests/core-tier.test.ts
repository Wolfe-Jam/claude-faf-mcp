 ...
 * adds faf_bench → 13; faf_enhance later removed — silent AI rewrite of .faf → 12).
 * Extended is opt-in via FAF_TOOLS=all. This test guards the one non-negotiable:
 * Extended defaults OFF. See PLANET-FAF/strategy/claude-faf-mcp-core-tier-glama-a-2026-06-17.md.
 */
